...
//					console.log('方案详情返回数据: ', obj);
  ...
  projectDetailObj.isFastLottery = function(){
	  var arr = ['tjsyy','gd11x5', 'gx11x5','xj11x5', 'sd11x5', 'gxk3','jxk3'];
...
//	  	console.log(ConfigObj.fastK3Type);
		   if(!this.isFastLottery() || this.lotteryType == 'jxk3'){   //普通数字彩
			   // 快三的方案详情已经用 PHP 生成好了
...
//		  }
  ...
  projectDetailObj.isNumLottery = function(){
	    var self = this;
	    var arr = ['dlt','pl5','pl3','qxc','tjsyy','gd11x5','gx11x5','xj11x5', 'sd11x5', 'hn4j1','ssq','gxk3','jxk3','d3'];   //数字彩[包括高频]
